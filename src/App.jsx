...
const App = () => {
  ...
  const applyClassesForSlide = () => {
    ...
    if (window.scrollY > 10) {
      ...
      navMenuDiv.current.classList.add('bg-gray-100');
    }
  };
  ...
  useEffect(() => {
    document.addEventListener('scroll', applyClassesForSlide);

    return () => {
      document.removeEventListener('scroll', applyClassesForSlide);
    };
  }, []);
        ...
        <div className='container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center'>
          ...
          <div className='flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left'>
            ...
            <p className='leading-normal text-2xl mb-8'>
              これは雛形です。雛形です。雛形です。雛形です。雛形です。雛形です。
            </p>
          ...
          <div className='w-full md:w-3/5 py-6 text-center'>
            <img className='w-full md:w-4/5 z-50' src={imageUrl} />
          </div>
        </div>
      </div>
          ...
          <div className='flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4'>
            <div className='flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4'>
              <div className='flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow'>
                ...
                <ul className='w-full text-center text-sm'>
                  <li className='border-b py-4'>あれ</li>
                  <li className='border-b py-4'>これ</li>
                  <li className='border-b py-4'>それ</li>
                </ul>
              </div>
              <div className='flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6'>
                <div className='w-full pt-6 text-3xl text-gray-600 font-bold text-center'>
                  ￥1,980
                  <span className='text-base'>／毎月</span>
                </div>
                <div className='flex items-center justify-center'>
                  <button className='mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out'>
                    登録
            ...
            <div className='flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-white mt-4 sm:-mt-6 shadow-lg z-10'>
              <div className='flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow'>
                ...
                <ul className='w-full text-center text-base font-bold'>
                  <li className='border-b py-4'>Basicに加えて</li>
                  <li className='border-b py-4'>あんなことは</li>
                  <li className='border-b py-4'>こんなことや</li>
                  <li className='border-b py-4'>そんなことも</li>
                </ul>
              </div>
              <div className='flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6'>
            ...
            <div className='flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4'>
              <div className='flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow'>
                ...
                <ul className='w-full text-center text-sm'>
                  <li className='border-b py-4'>Standardに加えて</li>
                  <li className='border-b py-4'>神対応</li>
                  <li className='border-b py-4'>すごすぎる</li>
                </ul>
              </div>
              <div className='flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6'>
                <div className='w-full pt-6 text-3xl text-gray-600 font-bold text-center'>
        ...
        <div className='container mx-auto px-8'>
          <div className='w-full flex flex-col md:flex-row py-6'>
            ...
            <div className='flex-1'>
              <p className='uppercase text-gray-500 md:mb-6'>お問い合わせ</p>
            ...
            <div className='flex-1'>
              <p className='uppercase text-gray-500 md:mb-6'>規制関連</p>
              <ul className='list-reset mb-6'>
                <li className='mt-2 inline-block mr-2 md:block md:mr-0'>
                  <a
                    href='#'
            ...
            <div className='flex-1'>
              <p className='uppercase text-gray-500 md:mb-6'>企業情報</p>
              <ul className='list-reset mb-6'>
                <li className='mt-2 inline-block mr-2 md:block md:mr-0'>
                  <a
                    href='#'
